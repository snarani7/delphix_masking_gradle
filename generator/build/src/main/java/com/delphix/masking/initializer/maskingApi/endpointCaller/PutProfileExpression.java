...
public class PutProfileExpression extends PutApiCall {
    ...
    public String getEndpoint() {
        try {
            return Post_PROFILE_EXPRESSION_PATH + URLEncoder.encode(id, "ISO-8859-1").replace("+", "%20");
        } catch (UnsupportedEncodingException e) {
            throw new RuntimeException(e);
        }
    }

    public PutProfileExpression(ProfileExpression profileExpression) {
